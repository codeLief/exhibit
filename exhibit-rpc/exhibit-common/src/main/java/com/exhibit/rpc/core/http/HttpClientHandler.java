    ...
    * */
    ...
    protected String responseAsString(CloseableHttpResponse response) {
        ...
        try {
            ...
            return new String(baos.toByteArray(), ConstantsUtil.ENCODE);
        } catch (IOException e) {
    ...
    public boolean isNormal(CloseableHttpResponse response) {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	HttpClientHandler httpClientHandler = new HttpClientHandler("http://10.37.253.76:8191/babysitter-remote/");
    	
    	CloseableHttpResponse response = httpClientHandler.sendRequest();
    	
    	System.out.println(httpClientHandler.responseAsString(response));
    	System.out.println(httpClientHandler.isNormal(response));
	}
}